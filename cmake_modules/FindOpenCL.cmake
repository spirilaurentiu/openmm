# OPENCL_INCLUDE_DIR ### Try OPENCL_DIR variable before looking elsewhere
find_path(
  OPENCL_INCLUDE_DIR
...
find_path(
  OPENCL_INCLUDE_DIR
  NAMES OpenCL/opencl.h CL/opencl.h
  PATHS $ENV{CUDA_PATH} $ENV{AMDAPPSDKROOT}
  PATH_SUFFIXES "include"
  NO_DEFAULT_PATH)
...
find_path(
  OPENCL_INCLUDE_DIR
  NAMES OpenCL/opencl.h CL/opencl.h
  PATHS "C:/CUDA" "/usr/local/cuda" "/usr/local/streamsdk" "/usr"
