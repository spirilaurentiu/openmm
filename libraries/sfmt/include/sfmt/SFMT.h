...
OPENMM_EXPORT const char* get_idstring();
OPENMM_EXPORT int get_min_array_size32();
OPENMM_EXPORT int get_min_array_size64();
OPENMM_EXPORT SFMTData* createSFMTData();
